...
| Modalidade | Descrição Técnica | Destaques no Blog |
| :--- | :--- | :--- |
| **Patinação Artística** | Foco em saltos, piruetas e a beleza dos rastros no gelo. | Yuzuru Hanyu, anatomia da lâmina e sapatilha. |
| **Hockey no Gelo** | Alta velocidade, contato físico e jogadas explosivas. | NHL, Connor McDavid e a física do *Puck*. |
| **Patinação Inline** | Liberdade urbana, velocidade e manobras de impacto. | Configurações *Rockered*, *Triskate* e frenagem T-Stop. |
...
| Tecnologia | Descrição no Projeto |
| :--- | :--- |
| <img src="https://img.shields.io/badge/html5-%23E34F26.svg?style=flat&logo=html5&logoColor=white" alt="HTML5" /> | Estruturação semântica das páginas, divisão de seções e contêineres de mídia. |
| <img src="https://img.shields.io/badge/css3-%231572B6.svg?style=flat&logo=css3&logoColor=white" alt="CSS3" /> | Layouts modernos, tipografias personalizadas e controle rigoroso de proporção de imagens. |
| <img src="https://img.shields.io/badge/bootstrap-%238511FA.svg?style=flat&logo=bootstrap&logoColor=white" alt="Bootstrap" /> | Framework utilizado para agilizar a estrutura de grid e responsividade das subpáginas. |
| <img src="https://img.shields.io/badge/javascript-%23F7DF1E.svg?style=flat&logo=javascript&logoColor=black" alt="JavaScript" /> | Lógica do sistema do Quiz, controle do placar e dinamismo de navegação. |
| <img src="https://img.shields.io/badge/node.js-6DA55F?style=flat&logo=node.js&logoColor=white" alt="NodeJS" /> | Ambiente de execução utilizado para gerenciamento de pacotes do projeto. |
| <img src="https://img.shields.io/badge/cypress-%2317202C.svg?style=flat&logo=cypress&logoColor=white" alt="Cypress" /> | Automação de testes de ponta a ponta (E2E) para garantir o funcionamento correto do Quiz e navegação. |
...
Para clonar e rodar este projeto na sua máquina, você precisará ter o [Git](https://git-scm.com) e o [Node.js](https://nodejs.org) instalados.
...
git clone [https://github.com/Heringson/IceAndStreet.git](https://github.com/Heringson/IceAndStreet.git)
